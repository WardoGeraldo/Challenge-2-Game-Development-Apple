...
final class GameOverModalScene: SKScene {
    ...
    private func setupNodes() {
        oopsModalNode = childNode(withName: "//oopsModalNode") as? SKSpriteNode
    ...
    private func setupScoreTexts() {
        ...
        scoreLabel?.fontColor = UIColor(red: 92/255, green: 53/255, blue: 22/255, alpha: 1)
        ...
        highscoreLabel?.fontColor = UIColor(red: 233/255, green: 92/255, blue: 107/255, alpha: 1)
    ...
    private func dismissModal(completion: (() -> Void)? = nil) {
        guard let modal = oopsModalNode else { completion?(); return }
